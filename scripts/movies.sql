...
CREATE TABLE `movie_catalog` (
  ...
  PRIMARY KEY (`id`),
  KEY `movie id fk` (`movie_id`),
  KEY `price id fk` (`price_id`),
  CONSTRAINT `movie id fk` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `price id fk` FOREIGN KEY (`price_id`) REFERENCES `prices` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-08 10:56:42
